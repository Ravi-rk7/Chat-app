        ...
        <div className="w-full max-w-md space-y-8">
          <div className="mb-8 text-center">
            <div className="group flex flex-col items-center gap-2">
              ...
              <p className="text-base-content/60">Build your profile and start chatting in realtime</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary h-12 w-full rounded-2xl" disabled={isSigningUp}>
              {isSigningUp ? (
                <>
